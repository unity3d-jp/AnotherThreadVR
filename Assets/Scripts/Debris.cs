...
public class Debris
{
	...
	public void render(int front, Camera camera, double render_time, float flow_speed, float dt)
	{
		if (material_ == null) {
			return;
		}
